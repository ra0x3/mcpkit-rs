...
///
/// ```rust,no_run
/// use mcpkit_rs::transport::streamable_http_client::{
...
///         _session_id: Arc<str>,
///         _auth_header: Option<String>,
///     ) -> Result<(), mcpkit_rs::transport::streamable_http_client::StreamableHttpError<Self::Error>> {
///         todo!()
///     }
///
///     async fn get_stream(
...
///         _auth_header: Option<String>,
///     ) -> Result<BoxStream<'static, Result<Sse, SseError>>, mcpkit_rs::transport::streamable_http_client::StreamableHttpError<Self::Error>> {
///         todo!()
///     }
/// }
///
