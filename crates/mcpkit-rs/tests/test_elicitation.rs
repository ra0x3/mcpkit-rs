...
async fn test_elicitation_capabilities() {
    use mcpkit_rs::model::{ClientCapabilities, ElicitationCapability};
...
mod typed_elicitation_tests {
    ...
    mcpkit_rs::elicit_safe!(UserConfirmation, UserProfile, UserPreferences);
    ...
    async fn test_typed_elicitation_simple_schema() {
        ...
        let schema = mcpkit_rs::handler::server::tool::schema_for_type::<UserConfirmation>();
    ...
    async fn test_typed_elicitation_complex_schema() {
        ...
        let schema = mcpkit_rs::handler::server::tool::schema_for_type::<UserProfile>();
    ...
    async fn test_enum_schema_generation() {
        // Test enum schema generation
        let schema = mcpkit_rs::handler::server::tool::schema_for_type::<Theme>();
    ...
    async fn test_nested_structure_schema() {
        ...
        let preferences_schema =
            mcpkit_rs::handler::server::tool::schema_for_type::<UserPreferences>();
...
async fn test_elicitation_capability_serialization() {
    use mcpkit_rs::model::ElicitationCapability;
...
async fn test_elicitation_action_error_mapping() {
    use mcpkit_rs::{model::ElicitationAction, service::ElicitationError};
...
async fn test_elicitation_type_safety() {
    use mcpkit_rs::service::ElicitationSafe;
    use schemars::JsonSchema;
    ...
    mcpkit_rs::elicit_safe!(SafeType);
...
async fn test_elicit_safe_macro() {
    ...
    mcpkit_rs::elicit_safe!(TypeA, TypeB, TypeC);

    // All should implement ElicitationSafe
    fn assert_all_safe<T: mcpkit_rs::service::ElicitationSafe>() {}
...
async fn test_elicitation_safe_trait() {
    ...
    mcpkit_rs::elicit_safe!(ObjectType);
...
async fn test_elicitation_examples_compile() {
    ...
    mcpkit_rs::elicit_safe!(UserProfile);

    // This should compile and work
    fn _example_usage() {
        fn _assert_safe<T: mcpkit_rs::service::ElicitationSafe>() {}
