...
impl ServerHandler for Server {
    ...
    async fn subscribe(
        &self,
        request: mcpkit_rs::model::SubscribeRequestParams,
...
impl ClientHandler for Client {
    async fn on_resource_updated(
        &self,
        params: mcpkit_rs::model::ResourceUpdatedNotificationParam,
...
impl ServerHandler for CustomServer {
    async fn on_custom_notification(
        ...
        _context: mcpkit_rs::service::NotificationContext<mcpkit_rs::RoleServer>,
    ) {
...
impl ServerHandler for CustomServerNotifier {
    async fn on_initialized(
        &self,
        context: mcpkit_rs::service::NotificationContext<mcpkit_rs::RoleServer>,
    ) {
