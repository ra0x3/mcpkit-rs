...
///
/// This will generate a function that return the attribute of this tool, with type `mcpkit_rs::model::Tool`.
///
/// ## Usage
///
/// | field             | type                       | usage |
...
/// # tool_router
///
/// This macro is used to generate a tool router based on functions marked with `#[mcpkit_rs::tool]` in an implementation block.
///
...
///     ) -> Result<CallToolResult, mcpkit_rs::ErrorData> {
...
///     ) -> Result<ListToolsResult, mcpkit_rs::ErrorData> {
...
///
/// This will generate a function that returns the attribute of this prompt, with type `mcpkit_rs::model::Prompt`.
///
/// ## Usage
///
/// | field             | type     | usage |
...
/// # prompt_router
///
/// This macro generates a prompt router based on functions marked with `#[mcpkit_rs::prompt]` in an implementation block.
///
